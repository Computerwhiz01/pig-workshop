...
-- ## TODO : change <your name>
billing_data2 = LOAD 'billing/in/sample.txt' USING PigStorage(',');
...
-- ## TODO : change <your name>
-- STORE  billing_data  into 'billing/pigout';
...
-- STORE billing_data into 'billing/pigout2' using PigStorage('|');
